...
class ImageSaver:
    ...
    def save(self, image: Image.Image, prompt: str, index: int = 1, 
             prefix: str = "txt2img") -> str:
        """保存图片并应用后处理"""
        ...
        filename = f"{timestamp}_{prefix}_{index}_{prompt_preview}.png"
