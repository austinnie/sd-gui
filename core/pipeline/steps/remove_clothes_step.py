...
class RemoveClothesStep(PipelineStep):
    """去掉衣服转换步骤"""
    ...
    def execute(self, context: StepContext) -> StepResult:
        ...
        try:
            ...
            for idx, job in enumerate(remove_clothes_prompts):
                print(f"   [{idx+1}/{len(remove_clothes_prompts)}] {job.get('name', 'unknown')}")
                ...
                result = pipe(
                    ...
                    num_inference_steps=config.get("steps", 35),
            ...
            return StepResult(
                ...
                metadata={
                    "output_count": len(remove_clothes_prompts),
