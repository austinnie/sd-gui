...
class ForestStep(PipelineStep, ControlNetMixin):
    """森林场景转换步骤 - 支持 ControlNet"""
    ...
    def execute(self, context: StepContext) -> StepResult:
        ...
        output_dir = os.path.join(context.output_dir, "forest")
        ...
        try:
            ...
            all_prompts = self._generate_forest_prompts()
            ...
            for idx, job in enumerate(prompts):
                ...
                output_path = os.path.join(output_dir, f"{idx+1:02d}_{job.get('name', 'forest')}.png")
