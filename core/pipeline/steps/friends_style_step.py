...
class FriendsStyleStep(PipelineStep, ControlNetMixin):
    """朋友聚会风格化 - 支持 ControlNet"""
    ...
    def execute(self, context: StepContext) -> StepResult:
        ...
        output_dir = os.path.join(context.output_dir, "friends_style")
        ...
        try:
            ...
            for idx, job in enumerate(prompts):
                ...
                output_path = os.path.join(output_dir, f"{idx+1:02d}_{job.get('name', 'friends_style')}.png")
