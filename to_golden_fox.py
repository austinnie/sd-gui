...
INPUT_IMAGE_NAME = "input" # 放任意一张你喜欢的动物或人像
SD_MODEL_PATH = "../models/sd-v1-5/anytimeRealistic_v10.safetensors" # 你的模型
...
def main():
    ...
    output_path = f"./output/golden_line_{datetime.now().strftime('%Y%m%d_%H%M%S')}.png"
