...
用法:
    ...
    python switch_lora.py --type sd15|sdxl         # 切换当前使用的 LoRA 类型
...
def show_status():
    ...
    print(f"  --set <名称>             设置默认 LoRA (如: --set MechaGirl)")
