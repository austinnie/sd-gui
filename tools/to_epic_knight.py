...
def main():
    ...
    # ✅ 核心修改：绝对路径拼接到 tools/output/epic_knight
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    output_dir = os.path.join(CURRENT_DIR, "output", "epic_knight")
    os.makedirs(output_dir, exist_ok=True)

    output_path = os.path.join(output_dir, f"epic_knight_{timestamp}.png")
